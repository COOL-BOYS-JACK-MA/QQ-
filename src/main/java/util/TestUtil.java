...
public class TestUtil {
    ...
    //直接F12复制你的请求url传进去就行
    public static String uri = "https://user.qzone.qq.com/proxy/domain/w.qzone.qq.com/cgi-bin/likes/internal_unlike_app?g_tk=1846091378";
    ...
    public void test_1() throws Exception {
        ...
        while (matcher.find()) {
            ...
            System.out.println("获得说说编号是" + strBuilder.toString());
